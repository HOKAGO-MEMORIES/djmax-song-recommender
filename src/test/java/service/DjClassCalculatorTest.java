...
public class DjClassCalculatorTest {
    ...
    void calculate_with_sampleList() {
        List<PlayRecordDto> records = List.of(
                new PlayRecordDto(179, "Lisrim", "onoken", "VE", "V EXTENSION", "MX", 2.1, 99.34, 57.6108, 133.739),
                new PlayRecordDto(631, "Diomedes", "XeoN", "VL", "V LIBERTY", "HD", 5.3, 99.10, 60.8395, 139.546),
